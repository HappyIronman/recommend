...
CRONJOBS = [('*/1 * * * *', 'homepage.task.craw_news_task.offline_craw', '>> ./log/cron.log'),
            ('*/2 * * * *', 'homepage.engine.engine.offline_cal_recommend_list', '>> ./log/cron.log'),
            ('*/3 * * * *', 'homepage.task.craw_news_task.delete_news', '>> ./log/cron.log')]
